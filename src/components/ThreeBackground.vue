<script setup>
import {ref, onMounted, onUnmounted, useCssVars} from 'vue'
...
class CustomShaderMaterial extends THREE.ShaderMaterial {
    constructor(){
        super({
            uniforms:{
                time:{value:0},
                color1:{value:new THREE.Color('#A1C4E2').multiplyScalar(1.2)},
                color2:{value:new THREE.Color('#C6DBF0').multiplyScalar(1.2)},
                color3:{value:new THREE.Color('#CFE8EF').multiplyScalar(1.2)},
            ...
            fragmentShader:`
                ...
                void main(){
                    ...
                    float dynamicWave = sin(uv.y * 8.0 + time * 0.5) * 0.1 + wave;
